...
const NavigationTheme = {
  ...
  colors: {
    ...
    textSecondary: ColorPalette.GRAY_300,
    ...
    secondarySubtitle: ColorPalette.GRAY_300,
...
const NavigationDarkTheme = {
  ...
  colors: {
    ...
    textSecondary: ColorPalette.WHITE_100,
    ...
    secondarySubtitle: ColorPalette.WHITE_100,
    buttonPrimaryBackground: ColorPalette.YELLOW_100,
